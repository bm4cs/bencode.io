...
Jon Gjengset is my hero. Not only is Jon a genius, he's an absolute machine doing 5+ hour live coding streams tackling difficult and low-level problems using Rust, such as building your own TCP/IP stack from the ground up. Checkout his [site](https://thesquareplanet.com/), [YouTube channel](https://www.youtube.com/c/JonGjengset) and [Tweets](https://twitter.com/jonhoo) for upcoming live stream which are not to be missed.
