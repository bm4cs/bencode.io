...
The SAP-1 defines a number of modules which are capable of integrated with the larger community of modules, to form a working CPU and ultimately computer.

![8-bit CPU architecture](/images/8bit-architecture.png)

Each module can be thought of as defining an API; they take inputs, they produce outputs.
