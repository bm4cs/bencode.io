...
- If you want to base a type on a struct that has methods ex: `type Contact Person`, methods will not flow to `Contact`, as they have a receiver type of `Person`
- Bummer.
