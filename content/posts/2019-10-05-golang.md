...
- [gob](https://pkg.go.dev/encoding/gob) streams for exchanging binary between an `Encoder` and `Decoder`. Handy for sending or receiving variables to a remote machine or a blob store.
